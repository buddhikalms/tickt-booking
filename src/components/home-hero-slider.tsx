      ...
      <div className="relative h-[360px] md:h-[420px]">
        {slides.map((slide, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-amber-950/85 via-amber-900/65 to-orange-900/25" />
          </div>
        ))}
        ...
        <div className="relative flex h-full flex-col justify-end p-6 text-white md:p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <Button asChild className="bg-amber-50 text-amber-900 hover:bg-amber-100">
              <Link href={`/events/${active.id}`}>Explore Program</Link>
            </Button>
